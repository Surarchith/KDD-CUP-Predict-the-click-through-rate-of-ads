...
val rawdata1=sc.textFile("hdfs://cshadoop1/user/axk155630/trainsample.txt").map(line=>line.split("\\t").map(_.toDouble)).map(line=>(line(2),line(3),line(4),line(5),line(6),line(7),line(8),line(9),line(10),line(11),(line(0)/line(1))))
